...
export default function NewPackPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-stone-400 mb-6">You need to sign in with GitHub to submit a pack.</p>
          <a
      ...
      <div className="min-h-screen grid-overlay py-16">
        <div className="mx-auto max-w-2xl px-6">
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading text-2xl font-bold text-stone-100">Pack Created!</h1>
          ...
          <div className="flex gap-3 mt-6 justify-center">
            <button
              onClick={() => router.push(`/packs/${form.slug}`)}
  ...
  return (
    <div className="min-h-screen grid-overlay py-16">
      <div className="mx-auto max-w-2xl px-6">
        <div className="mb-8">
          <h1 className="font-heading text-3xl font-bold text-stone-100">Submit a Pack</h1>
          <p className="text-stone-400 mt-2">
            List your modpack on the Alloy Pack Explorer. A GitHub webhook will be configured for auto-publishing releases.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="my-awesome-pack"
            />
            <p className="text-xs text-stone-500 mt-1">URL: alloymc.net/packs/{form.slug || "..."}</p>
          ...
          <div>
            ...
            <input
              ...
              maxLength={200}
              className="w-full px-3 py-2.5 rounded-lg border border-obsidian-700 bg-obsidian-900 text-stone-200 text-sm placeholder:text-stone-500 focus:outline-none focus:border-ember/50 transition-colors"
              placeholder="A brief description of what your pack offers (10-200 chars)"
            />
